...
export default class CreateRecordAccount extends LightningElement {
    ...
    changeHandler(event){
        ...
        this.formdata[name] = value; //formdata = {Name: "My account" ,Industry: "Biotech", AnnualRevenue: 10000.00}
    ...
    cancelAccount(){
        ...
        this.template.querySelector('lightning-combobox').value=undefined;  //reset picklist field
        this.formdata = {};
